...
List<String> tokyo = [
  'Tokyo (東京 Tōkyō, "Eastern Capital") is the capital and largest city of Japan located on the island of Honshu. Tokyo is the center of the Japanese government. The Imperial Palace is in Tokyo.',
...
List<String> london = [
  ...
  'London is the biggest city in western Europe, and the worlds largest financial centre.',
  ...
  'London is one of the worlds most important cities for business, finance, and politics. It is also important for culture: media, entertainment, fashion, and art.',
